...
if (!empty($_POST) && isset($_POST['lienUrl']) && isset($_POST['lienTitre']) && isset($_POST['description'])) {
    ...
    foreach ($_POST['categorie'] as $valeur) {
        $req = 'INSERT INTO `videos`(`url_video`, `titre_video`, `date_video`, `desc_video`, `categorie_video`, `etat_video`) VALUES ("' . $lienUrl . '","' . $lienTitre . '",  NOW()  ,"' . $description . '","' . $valeur . '","non publie")';
